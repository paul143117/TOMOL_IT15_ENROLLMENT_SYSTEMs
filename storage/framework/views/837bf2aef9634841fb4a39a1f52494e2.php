...
<div style="margin-bottom: 1.5rem;">
    <a href="<?php echo e(route('students.index')); ?>" style="font-size: 0.875rem; color: #4b5563; text-decoration: none;" onmouseover="this.style.color='#2563eb'" onmouseout="this.style.color='#4b5563'">&larr; Back to students</a>
</div>

<div class="portal-card">
    <div style="padding: 1.25rem 1.5rem; border-bottom: 1px solid #e5e7eb;">
        <h1 style="font-size: 1.5rem; font-weight: 700; color: #111; margin: 0;"><?php echo e($student->full_name); ?></h1>
        <dl style="margin: 0.75rem 0 0 0; display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem;">
            <div>
                ...
                <dd style="font-size: 0.875rem; color: #111; margin: 0.125rem 0 0 0;"><?php echo e($student->student_number); ?></dd>
            </div>
            <div>
                <dt style="font-size: 0.75rem; font-weight: 500; color: #6b7280; text-transform: uppercase; margin: 0;">Email</dt>
                <dd style="font-size: 0.875rem; color: #111; margin: 0.125rem 0 0 0;"><?php echo e($student->email); ?></dd>
            </div>
        </dl>
    </div>
            ...
            <ul style="margin: 0; padding: 0; list-style: none; border-top: 1px solid #e5e7eb;">
                <?php $__currentLoopData = $student->courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li style="padding: 0.75rem 0; display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid #e5e7eb;">
                        <div>
                            <span style="font-weight: 500; color: #111;"><?php echo e($course->course_name); ?></span>
                            <span style="color: #6b7280; font-size: 0.875rem; margin-left: 0.5rem;">(<?php echo e($course->course_code); ?>)</span>
                        </div>
                        <a href="<?php echo e(route('courses.show', $course)); ?>" class="link-blue" style="font-size: 0.875rem;">View course</a>
                    </li>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\nelyn\tomolenrollment\resources\views/students/show.blade.php ENDPATH**/ ?>